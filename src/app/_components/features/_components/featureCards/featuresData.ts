...
const featuresData: IFeatureData[] = [
	...
	// 	description: 'با ارسال پیامک‌های هوشمند، مشتریان وفادار بیشتری جذب کنید و با امکاناتی مانند تخفیف‌گذاری سه‌گانه، کیف پول الکترونیک و سیستم کش‌بک، آن‌ها را به خریدهای بیشتر تشویق کنید.',
	// },
	// {
	// 	title: 'پشتیبانی 7/24',
