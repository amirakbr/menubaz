...
const HeroSection = () => {
  return (
    <section className="grid grid-cols-1 xl:grid-cols-2 gap-4 items-center justify-center px-4">
      <div className="order-1 lg:order-2 flex items-center justify-center p-4 bg-white-200 rounded-xl">
        <Image alt="laptop image with menubaz logo" src={'/hero/hero.png'} width={400} height={300} priority />
      </div>
      <div className="order2 lg:order-1 flex flex-col gap-6">
        <h1 className="text-3xl font-bold text-center xl:text-right">
