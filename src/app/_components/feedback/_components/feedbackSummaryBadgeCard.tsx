...
const FeedbackSummaryCard = ({ title, subtitle, summary, icon: Icon }: IFeedbackSummaryCardProps) => {
  return (
    <div className="xl:w-max bg-white-200 flex items-center justify-between py-7 px-10 xl:py-4 xl:px-6 rounded-lg gap-8">
      <div>
