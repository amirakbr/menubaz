  ...
  return (
    <>
      <div className="relative">
        <div className="px-8 z-10 relative flex items-center justify-evenly gap-8">
          <div className="p-1 rounded-xl bg-gray-100 hidden xl:block">
            <Image alt="menubaz panel logo" src={'/analytics/mobileMenubaz.png'} width={200} height={200} className="rounded-xl" />
          </div>
