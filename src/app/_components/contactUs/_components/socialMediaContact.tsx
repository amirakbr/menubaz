...
const SocialMediaContact = () => {
  return (
    <div className="order-2 xl:order-1 xl:w-[368px] xl:h-[276px] flex flex-col gap-4 items-center justify-center bg-white-200 rounded-lg p-4">
      ...
      <div className="flex items-center gap-4 font-medium text-xs xl:text-sm">
        <p className="text-title-400">پاسخگوی تلگرام</p>
        <Link
          className="text-base text-complementary"
      ...
      <div className="flex items-center gap-4 font-medium text-xs xl:text-sm">
        <p className="text-title-400">پاسخگوی واتساپ</p>
        <Link
          className="text-base text-complementary"
          href={"mailto:support@menobuzz.com"}
        >
      ...
      <p className="text-center text-title-400 text-xs">
        تفاوت را با منوباز تجربه کنید. تیم پشتیبانی اختصاصی ما اینجاست تا به شما
        24 ساعته کمک کند و از تجربه ایمیلی روان و بدون دردسر اطمینان حاصل کند.
      </p>
    </div>
  );
};
