...
const HomeIcon = ({ height = 24, width = 24, primaryColor = '#595959', secondaryColor = '#595959' }: IIConProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 24 24">
      <path fill={secondaryColor} d="M12 18.75c-.41 0-.75-.34-.75-.75v-3c0-.41.34-.75.75-.75s.75.34.75.75v3c0 .41-.34.75-.75.75"></path>
      <path
        fill={primaryColor}
