...
const ArrowLeftIcon = ({ height = 16, width = 16 }: IIConProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill="none" viewBox="0 0 16 16">
      ...
      ></path>
      <path fill="#5B21FF" d="M13.667 8.5H2.447a.504.504 0 0 1-.5-.5c0-.273.226-.5.5-.5h11.22c.273 0 .5.227.5.5s-.227.5-.5.5"></path>
    </svg>
  );
};
