...
const PrinterIcon = ({ height = 24, width = 24 }: IIConProps) => {
	return (
		<svg
			...
			<path
				fill='#595959'
				d='M17 15.75H7c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h10c.41 0 .75.34.75.75s-.34.75-.75.75M10 11.75H7c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h3c.41 0 .75.34.75.75s-.34.75-.75.75'></path>
		</svg>
	);
};
