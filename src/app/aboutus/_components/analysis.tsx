...
const Analysis = () => {
	return (
		<div className='flex flex-col gap-3 items-center md:w-min md:m-auto '>
				...
				{analysisData.map(({ analysis, icon: Icon, label }, index) => {
					return (
						<div
							...
							<span className='text-2xl md:text-4xl ltr font-bold bg-gradient-to-b from-[#5B21FF] to-[#361499] bg-clip-text text-transparent'>+{analysis}</span>
			...
			<div className='grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-7'>
				...
				<div className='bg-white-200 rounded-lg flex flex-col gap-1 md:gap-3 py-4 px-7 md:items-center md:text-center'>
					...
					<div className='flex flex-col gap-1'>
						...
						<h4 className='text-xs text-subtitle leading-5'>
							هر رستوران داستان خودش را دارد و ما در منوباز آن را درک می‌کنیم. با فناوری‌های پیشرفته و شناخت نیازهای بازار، ابزارهایی طراحی کرده‌ایم که مدیریت و رشد کسب‌وکار شما را ساده‌تر کند. چه
							تازه شروع کرده باشید یا سال‌ها تجربه داشته باشید، ما همراه شما هستیم.
						</h4>
					</div>
				</div>
			</div>
