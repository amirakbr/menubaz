		...
		<div className='flex flex-col gap-7 lg:flex-row lg:justify-between lg:items-center'>
			<div className='flex flex-col gap-6 max-w-[594px]'>
				...
				<p className='text-title-400 font-medium text-xl'>
					با منو دیجیتال منحصر به فرد خود، به سادگی می توانید از هر جایی بر تمامی شعب و بخش های مجموعه خود از قبیل سفارش گیری، پرداخت و فروش رستوران یا کسب و کار های مرتبط دیگر، مدیریت داشته باشید. از
					وضعیت (باز یا بسته بودن) و موجودی رستوران گرفته تا گزارش های پرداختی، رفتار و علایق مشتری ها و...، همه و همه در اختیار شماست.
				</p>
				<Button
					variant='secondary'
					className='w-max'>
