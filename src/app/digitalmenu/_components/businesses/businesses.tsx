		...
		<div className='flex flex-col gap-12'>
			<div className='flex flex-col gap-4 items-center text-center'>
				...
				<p className='text-title font-medium'>
					رستوران یا کافی شاپ، فست فود یا فود کورت، بوفه یا فود استریت، قنادی یا بستنی فروشی، کترینگ و یا حتی هتل! منو باز به درد همه خواهد خورد و با نیاز های تخصصی ای که برای هر یک از این کسب و کار
					ها دارد، می تواند موجب افزایش چشم گیری در کیفیت ارائه خدمات، کاهش هزینه ها و حتی خطاهای انسانی شود. پس اگر شما هم می خواهید از تمام رقیبانتان متمایز شوید و یا کسب و کار خود را گسترش دهید،
