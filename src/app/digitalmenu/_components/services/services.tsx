...
const servicesData = [
	...
	},
	{
		...
		description: 'با استفاده از این قابلیت منو باز، مشتریان شما این امکان را خواهند داشت تا محصولات مورد نظر خود را با هر سایز و ویژگی ای در قالب قاعده های از پیش تعیین شده، سفارش دهند.',
		...
		<div className='flex flex-col gap-5 lg:gap-10'>
			{servicesData?.map(({ description, imageSrc, subtitle, title }, index) => (
				<div
					...
					<div className={`w-96 h-52 lg:h-64 rounded-xl overflow-hidden relative m-auto ${index % 2 === 1 ? 'lg:order-1 lg:justify-self-start' : 'lg:order-2 lg:justify-self-end'}`}>
						<Image
							fill
							alt={`${imageSrc} image`}
							src={imageSrc}
