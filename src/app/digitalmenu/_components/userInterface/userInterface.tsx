...
const UserInterface = () => {
  return (
    <div>
      ...
      <div className="mx-4 p-4 rounded-xl bg-whiteBlack-100 rounded-xl drop-shadow-userInterfaceDesignCard relative bottom-11">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-8">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-1 text-8">
              ...
              <span className="text-title text-10 font-medium">190,000 تومان</span>
            </div>
          </div>
          <HamburgerImage />
        </div>
